...
public class BootstrapSettings implements TBase<BootstrapSettings>, java.io.Serializable, Cloneable {
  ...
  private static final TField ENABLE_PUBLIC_NOTEBOOKS_FIELD_DESC = new TField("enablePublicNotebooks", TType.BOOL, (short)13);
  ...
  public int compareTo(BootstrapSettings other) {
    ...
    lastComparison = Boolean.valueOf(isSetEnablePublicNotebooks()).compareTo(typedOther.isSetEnablePublicNotebooks());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnablePublicNotebooks()) {      lastComparison = TBaseHelper.compareTo(this.enablePublicNotebooks, typedOther.enablePublicNotebooks);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
